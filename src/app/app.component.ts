...
export class AppComponent implements AfterViewInit, AfterViewChecked, AfterContentChecked {
	 ...
	 * @example <caption>Opening the dialog in html</caption>
	 * <button mat-button (click)="openExperiments">Open Experiment Dialog</button>
	 * @return {void}
	 */
	openExperiments() {
	 ...
	 * @param {string|any} link The URL to go to
	 * @returns {void}
	 */
